import {
  ...
  rpcUrl,
  v4_default
} from "./chunk-PDLCE4FB.js";
import {
  require_buffer
} from "./chunk-N7O3WYI7.js";
      ...
      if (request.method === "eth_requestAccounts" || request.method === "eth_accounts") {
        ...
        if (request.params && request.params instanceof Array && request.params[0]) {
          ...
          if (isNullish(txData.type)) {
            if (chains_exports.isChainSupportEIP1559(this.auth.getChain())) {
              txData.type = "0x2";
            } else {
              txData.type = "0x0";
            }
        ...
        if (request.params && request.params instanceof Array && request.params.length >= 2) {
          ...
          if (typeof typedData === "string" && !typedData.startsWith("0x")) {
            typedData = addHexPrefix(import_buffer.Buffer.from(typedData).toString("hex"));
          }
        ...
        if (request.params && request.params instanceof Array && request.params[0] && request.params[0].chainId) {
          ...
          const chain = chains_exports.getEVMChainInfoById(chainId);
          if (chain) {
  ...
  legacyToString(params) {
    ...
    if (typeof params === "number") {
      ...
      if (params.toString().startsWith("0x")) {
        ...
        message = addHexPrefix(import_buffer.Buffer.from(params).toString("hex"));
      }
    } else {
      message = addHexPrefix(import_buffer.Buffer.from(JSON.stringify(params)).toString("hex"));
    }
    return message;
  }
};
  ...
  request(request) {
    return __async(this, null, function* () {
      ...
      const rpcRequest = {
        ...
        id: (_a = request.id) != null ? _a : v4_default(),
...
//# sourceMappingURL=es-HPNP6I3Y.js.map
