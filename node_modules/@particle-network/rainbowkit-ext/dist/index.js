...
// src/particleWallet/particleConnector.ts
import { ChainNotConfiguredError, Connector, ConnectorNotFoundError } from "wagmi";
...
var ParticleConnector = class extends Connector {
  ...
  getProvider() {
    return __async(this, null, function* () {
      ...
      if (!this.provider) {
        const { ParticleProvider } = yield import("@particle-network/provider");
...
// src/particleWallet/particleWallet.ts
var particleWallet = ({ chains, authType }) => ({
  ...
  iconUrl: () => __async(void 0, null, function* () {
    const icons = yield import("./icons-JBREMNTX.js");
