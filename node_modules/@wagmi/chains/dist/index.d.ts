...
declare const emerald: {
    ...
    readonly network: "emerald";
    readonly nativeCurrency: {
        readonly decimals: 18;
        readonly name: "Oasis ROSE";
        readonly symbol: "ROSE";
    };
    readonly rpcUrls: {
        readonly default: {
            readonly http: readonly ["https://emerald.oasis.dev"];
            readonly webSocket: readonly ["wss://emerald.oasis.dev/ws"];
        };
        readonly public: {
            readonly http: readonly ["https://emerald.oasis.dev"];
            readonly webSocket: readonly ["wss://emerald.oasis.dev/ws"];
...
declare const ewc: {
    ...
    readonly blockExplorers: {
        readonly default: {
            readonly name: "Energy Web Chain Explorer";
            readonly url: "https://explorer.energyweb.org";
        };
    };
    readonly contracts: {
        readonly ensRegistry: {
            readonly address: "0x0A6d64413c07E10E890220BBE1c49170080C6Ca0";
        };
    };
};
...
declare const sapphireTestnet: {
    readonly id: 23295;
    readonly name: "Oasis Sapphire Testnet";
    readonly network: "sapphireTestnet";
    readonly nativeCurrency: {
        readonly decimals: 18;
        readonly name: "Oasis TEST";
...
declare const volta: {
    readonly id: 73799;
    readonly name: "Volta Chain";
    readonly network: "volta";
    readonly nativeCurrency: {
        readonly name: "VT";
        readonly symbol: "VT";
        readonly decimals: 18;
    ...
    readonly rpcUrls: {
        readonly default: {
            readonly http: readonly ["https://volta-rpc.energyweb.org"];
        };
        readonly public: {
            readonly http: readonly ["https://volta-rpc.energyweb.org"];
        };
    ...
    readonly blockExplorers: {
        readonly default: {
            readonly name: "Volta Explorer";
            readonly url: "https://volta-explorer.energyweb.org";
        };
    };
    readonly contracts: {
        readonly ensRegistry: {
            readonly address: "0xd7CeF70Ba7efc2035256d828d5287e2D285CD1ac";
        };
    };
};
...
export { Chain, arbitrum, arbitrumGoerli, arbitrumNova, aurora, auroraTestnet, avalanche, avalancheFuji, base, baseGoerli, bearNetworkChainMainnet, bearNetworkChainTestnet, boba, bronos, bronosTestnet, bsc, bscTestnet, bxn, bxnTestnet, canto, celo, celoAlfajores, celoCannoli, classic, confluxESpace, cronos, cronosTestnet, crossbell, dfk, dogechain, edgeware, edgewareTestnet, ekta, ektaTestnet, emerald, eos, eosTestnet, evmos, evmosTestnet, ewc, fantom, fantomTestnet, fibo, filecoin, filecoinCalibration, filecoinHyperspace, flare, flareTestnet, foundry, fuse, fuseSparknet, gnosis, gnosisChiado, gobi, goerli, haqqMainnet, haqqTestedge2, hardhat, harmonyOne, iotex, iotexTestnet, klaytn, linea, lineaTestnet, localhost, mainnet, mantle, mantleTestnet, metis, metisGoerli, mev, mevTestnet, modeTestnet, moonbaseAlpha, moonbeam, moonriver, neonDevnet, nexi, nexilix, oasys, okc, optimism, optimismGoerli, polygon, polygonMumbai, polygonZkEvm, polygonZkEvmTestnet, pulsechain, pulsechainV4, qMainnet, qTestnet, rollux, rolluxTestnet, ronin, saigon, sapphire, sapphireTestnet, scrollSepolia, scrollTestnet, sepolia, shardeumSphinx, skaleBlockBrawlers, skaleCalypso, skaleCalypsoTestnet, skaleChaosTestnet, skaleCryptoBlades, skaleCryptoColosseum, skaleEuropa, skaleEuropaTestnet, skaleExorde, skaleHumanProtocol, skaleNebula, skaleNebulaTestnet, skaleRazor, skaleTitan, skaleTitanTestnet, songbird, songbirdTestnet, syscoin, syscoinTestnet, taikoTestnetSepolia, taraxa, taraxaTestnet, telos, telosTestnet, thunderTestnet, volta, wanchain, wanchainTestnet, xdc, xdcTestnet, zetachainAthensTestnet, zhejiang, zkSync, zkSyncTestnet, zora, zoraTestnet };
